...
Important: uninstall the old ColumbiaWalks Android app before installing 3.12.0. First allow any locally saved reports to finish submitting, because uninstalling removes reports that exist only on the phone.
